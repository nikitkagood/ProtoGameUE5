...
public:
	...
	virtual bool MoveItemToInventory(UItemBase* item, TScriptInterface<IInventoryInterface> destination, FIntPoint new_upper_left_cell) override { checkf(false, TEXT("Abstract class doesn't have this implementation. Check child classes.")); return false; };
	...
	virtual bool ReceiveItem(UItemBase* item, FIntPoint new_upper_left_cell) override { checkf(false, TEXT("It's not supported. This class doesn't have any grid.")); return false; };
